...
replace gioui.org => github.com/mixmasala/gio v0.0.0-20221228203809-26bd44569a64
...
require (
	...
	github.com/katzenpost/katzenpost v0.0.18
...
require (
	...
	github.com/katzenpost/doubleratchet v0.0.13 // indirect
